...
namespace Hotel_Reservations_Manager.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoomNumber,Capacity,IsAvailable,AdultPrice,ChildPrice")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoomNumber,Capacity,IsAvailable,AdultPrice,ChildPrice")] Room room)
        {
